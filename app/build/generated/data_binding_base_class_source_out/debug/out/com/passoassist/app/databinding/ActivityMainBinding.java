...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull DrawerLayout rootView, @NonNull DrawerLayout drawerLayout,
      @NonNull FloatingActionButton fabRefresh, @NonNull FloatingActionButton fabScan,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((DrawerLayout) rootView, drawerLayout, fabRefresh, fabScan,
          fragmentContainer, navView, progressBar, toolbar, webview);
    }
